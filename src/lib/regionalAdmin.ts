...
export const INITIAL_SOURCES = [
  ...
  // F. 埼玉・大阪
  // 旧 list_url は 2019年9月付の固定「まとめ記事」1本で新着一覧ではなかった（新しい個店記事が永久に取れない）。
  // 実在する「開店・閉店」カテゴリの新着一覧に是正（実測200・記事リンク96本）。
  { name: 'さいたまっぷる ニューオープン', base_url: 'https://jutaro123.com/', list_url: 'https://jutaro123.com/category/%E9%96%8B%E5%BA%97%E3%83%BB%E9%96%89%E5%BA%97', media_family: 'local_blog', source_type: 'openclose_article', parser_type: 'regional_blog_openclose', rendering_mode: 'static', category_label: '開店閉店', is_active: true, reliability_score: 82, crawl_interval_hours: 24 },
