...
const CHAIN_HINT = /(マクドナルド|スターバックス|スタバ|ケンタッキー|モスバーガー|ガスト|サイゼリヤ|吉野家|すき家|松屋|ドトール|タリーズ|コメダ|丸亀製麺|ユニクロ|\bGU\b|ＧＵ|セブン-?イレブン|ファミリーマート|ローソン|QBハウス|TBC|ミュゼ|RIZAP|ライザップ|チョコザップ|chocoZAP|カーブス|ゴールドジム|明光義塾|公文|KUMON|ほっともっと|大戸屋|やよい軒|アパマン|エイブル|ミニミニ|りらくる|ほぐしの達人|大東建託)/
