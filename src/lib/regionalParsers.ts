...
// 新店ではない（除外）
const NEWNESS_EXCLUDE = /(新メニュー|新商品|新サービス|キャンペーン|イベント|フェア|求人|スタッフ募集|アルバイト|バイト募集|周年|クーポン|ポップアップ|pop-?up|セール|福袋|モニター募集|モニターを?募集|出張買取|買取(強化|キャンペーン|フェア)|(参加者|会員|モニター)を?募集|プレゼント企画)/i
