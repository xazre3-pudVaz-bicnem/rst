...
// 催事・興行・地域行事の語。これらが本文/タイトルにあれば新店ではなくイベント記事として除外する。
// ※「お笑いライブが9/6開催」等が新店として投入され、開催日を開業日と誤読していたため拡充。
//   店名に紛れうる語（祭/大会 単独など）は避け、興行/催事に固有の語に限定。
const EVENT_WORDS = [
  'イベント', 'マルシェ', '催事', 'ポップアップ', 'popup', '期間限定', '周年', 'キャンペーン', 'フェア', '求人', '採用', 'スタッフ募集', '新メニュー', '新作', 'セール',
  // 興行・公演
  '開催', 'お笑いライブ', 'ライブが', 'ライブを', 'ライブ開催', 'ライブ配信', 'コンサート', '公演', '演奏会', 'リサイタル', '音楽祭', 'フェス', 'フェスティバル', '上映会', '映画祭', 'トークショー', '握手会', 'サイン会', '観覧募集', '公開収録',
  // 地域行事・催し
  '花火大会', '盆踊り', '夏祭り', '秋祭り', '縁日', '撮影会', '抽選会', '福引', '見本市', '品評会', 'コンテスト', 'オーディション', '選手権', 'eスポーツ大会',
]
