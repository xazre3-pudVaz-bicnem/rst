...
export const DISCOVERY_SOURCES: DiscoverySourceDef[] = [
  ...
  { type: 'job_opening_search', label: 'オープニングスタッフ求人', group: '求人由来', mode: 'serp', defaultEnabled: true, signalType: 'job_opening', freshness: 'month',
    queries: ['オープニングスタッフ 店舗 電話番号', 'オープニングスタッフ 新規オープン 住所', '新規オープン スタッフ募集 電話', 'オープニングスタッフ 飲食店 開店', 'オープニングスタッフ カフェ 開業', 'オープニングスタッフ 美容室 新規', 'オープニングスタッフ ネイルサロン', 'オープニングスタッフ 整体院', 'オープニングスタッフ エステ 開業', '新規開院 スタッフ募集 歯科', '開業予定 クリニック 求人', 'オープニングスタッフ 動物病院', 'オープニングスタッフ ジム 開業',
      'site:indeed.com オープニングスタッフ 新規オープン', 'site:townwork.net オープニングスタッフ 開店', 'site:baitoru.com オープニングスタッフ 新規', 'site:jp.indeed.com オープニングスタッフ 開業 店舗'] },
  ...
  { type: 'construction_case_opening_crawl', label: '内装/看板/工務店 施工事例', group: '施工事例由来', mode: 'serp', defaultEnabled: true, signalType: 'construction_case', freshness: 'month',
    queries: ['"店舗内装" "施工事例" "新規オープン"', '"看板施工" "新規オープン"', '"美容室 内装 施工事例 オープン"', '"飲食店 内装 施工事例 オープン"', '"クリニック 内装 施工事例 開院"', '"看板が完成しました" "オープン"', '"ネイルサロン 内装 施工事例"', '"エステサロン 内装 施工事例 オープン"', '"整体院 内装 施工事例 開業"', '"トリミングサロン 内装 施工事例"', '"ジム 内装 施工事例 オープン"', '"店舗デザイン 施工実績 新規オープン"'] },
  ...
  { type: 'reserva_new_business_scan', label: 'RESERVA新規事業者', group: 'ポータル/予約/メニュー', mode: 'serp', defaultEnabled: true, signalType: 'reservation_page_published', freshness: 'month',
    queries: ['site:reserva.be "新規オープン"', 'site:reserva.be オープン 店舗', 'site:reserva.be 開業 サロン', 'site:reserva.be 予約受付開始 整体', 'site:coubic.com "新規オープン"', 'site:coubic.com 開業 教室'] },
  { type: 'stores_reservation_new_scan', label: 'STORES予約新規', group: 'ポータル/予約/メニュー', mode: 'serp', defaultEnabled: true, signalType: 'reservation_page_published', freshness: 'month',
    queries: ['"STORES予約" "新規オープン"', 'site:stores.jp 予約 開業 店舗', '"STORES予約" 開業 サロン', '"STORES予約" 予約受付開始'] },
  { type: 'airreserve_business_scan', label: 'Airリザーブ事業者', group: 'ポータル/予約/メニュー', mode: 'serp', defaultEnabled: true, signalType: 'reservation_page_published', freshness: 'month',
    queries: ['site:airrsv.net "新規オープン"', 'site:airrsv.net オープン 店舗', 'site:airrsv.net 開業 サロン', 'site:airrsv.net 予約受付開始 整体'] },
